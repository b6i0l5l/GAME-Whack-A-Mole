...
public class Moving8 : MonoBehaviour
{
    ...
    void Update()
    {
        gamemanger.GetComponent<GameManerger>().openhole8 = false;
        ...
        {
            speed = 0f;
            gamemanger.GetComponent<GameManerger>().molespeed8 = false;
        ...
        if (theposition - initialpositiony <= 0f)
        {
            ...
            if (gamemanger.GetComponent<GameManerger>().molespeed8 == true)
            {
                speed = 1;
            }
            else if (gamemanger.GetComponent<GameManerger>().molespeed8 == false)
            {
                gamemanger.GetComponent<GameManerger>().openhole8 = true;
                this.enabled = false;
            }
