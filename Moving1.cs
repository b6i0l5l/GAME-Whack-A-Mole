...
public class Moving1 : MonoBehaviour
{
    ...
    void Update()
    {
        gamemanger.GetComponent<GameManerger>().openhole1 = false;
        ...
        {
            speed = 0f;
            gamemanger.GetComponent<GameManerger>().molespeed1 = false;
        ...
        if (theposition - initialpositiony <= 0f)
        {
            ...
            if (gamemanger.GetComponent<GameManerger>().molespeed1 == true)
            {
                speed = 1;
            }
            else if (gamemanger.GetComponent<GameManerger>().molespeed1 == false)
            {
                gamemanger.GetComponent<GameManerger>().openhole1 = true;
                this.enabled = false;
            }
