...
public class Moving5 : MonoBehaviour
{
    ...
    void Update()
    {
        gamemanger.GetComponent<GameManerger>().openhole5 = false;
        ...
        {
            speed = 0f;
            gamemanger.GetComponent<GameManerger>().molespeed5 = false;
        ...
        if (theposition - initialpositiony <= 0f)
        {
            ...
            if (gamemanger.GetComponent<GameManerger>().molespeed5 == true)
            {
                speed = 1;
            }
            else if (gamemanger.GetComponent<GameManerger>().molespeed5 == false)
            {
                gamemanger.GetComponent<GameManerger>().openhole5 = true;
                this.enabled = false;
            }
