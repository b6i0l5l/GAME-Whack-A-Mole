...
public class Moving3 : MonoBehaviour
{
    ...
    void Update()
    {
        gamemanger.GetComponent<GameManerger>().openhole3 = false;
        ...
        {
            speed = 0f;
            gamemanger.GetComponent<GameManerger>().molespeed3 = false;
        ...
        if (theposition - initialpositiony <= 0f)
        {
            ...
            if (gamemanger.GetComponent<GameManerger>().molespeed3 == true)
            {
                speed = 1;
            }
            else if (gamemanger.GetComponent<GameManerger>().molespeed3 == false)
            {
                gamemanger.GetComponent<GameManerger>().openhole3 = true;
                this.enabled = false;
            }
