...
public class Moving6 : MonoBehaviour
{
    ...
    void Update()
    {
        gamemanger.GetComponent<GameManerger>().openhole6 = false;
        ...
        {
            speed = 0f;
            gamemanger.GetComponent<GameManerger>().molespeed6 = false;
        ...
        if (theposition - initialpositiony <= 0f)
        {
            ...
            if (gamemanger.GetComponent<GameManerger>().molespeed6 == true)
            {
                speed = 1;
            }
            else if (gamemanger.GetComponent<GameManerger>().molespeed6 == false)
            {
                gamemanger.GetComponent<GameManerger>().openhole6 = true;
                this.enabled = false;
            }
